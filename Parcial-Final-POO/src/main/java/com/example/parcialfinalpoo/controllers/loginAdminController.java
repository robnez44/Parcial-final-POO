...
public class loginAdminController implements Initializable {
    ...
    @FXML
    private void volverboton(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/parcialfinalpoo/viewers/menuInicioSesion.fxml"));

        try {
            Parent root = loader.load();
            menuInicioSesionController controller = loader.getController();
    ...
    public void loginButton(ActionEvent event) {
        ...
        if (usernameTextFile.getText().isBlank() == false && CONTRATEXT.getText().isBlank() == false) {
            validateLogin();
        } else {
